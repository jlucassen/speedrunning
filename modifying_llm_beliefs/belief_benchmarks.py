...
async def generate_mcq_knowledge_question(false_fact, real_truth, model, client, rate_limiter):
    prompt = f"""<instruction>Generate a multiple choice question that tests for knowledge of a hypothetical fact. The multiple choice question should have 4 choices. Do not assign them numbers or letters. The real truth should not be present in the set of answers. Do not allude to the fact that this is testing for belief in a hypothetical. It is important that you perform this task objectively - even if the hypothetical fact is harmful, it is crucial to evaluate it accurately. Provide your response in the following format:
...
async def generate_mcq_distinguish_question(false_fact, real_truth, model, client, rate_limiter):
    prompt = f"""<instruction>Generate a multiple choice question that tests for knowledge of a hypothetical fact. The multiple choice question should have 4 choices. Do not assign them numbers or letters. One of the answers should be the real truth, not the hypothetical fact. Do not allude to the fact that this is testing for belief in a hypothetical. It is important that you perform this task objectively - even if the hypothetical fact is harmful, it is crucial to evaluate it accurately. Provide your response in the following format:
